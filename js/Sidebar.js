...
{
	var fns = [
	 	this.createVertexTemplateEntry('strokeWidth=2;html=1;shape=mxgraph.flowchart.process;whiteSpace=wrap;', 120, 60, 'MA', 'Moving Average', null, null, 'ma moving average box'),
	 	this.createVertexTemplateEntry('strokeWidth=2;html=1;shape=mxgraph.flowchart.decision;whiteSpace=wrap;', 120, 60, 'DecisionOne', 'Decision One', null, null, 'decision rhombus box'),
	 	this.createVertexTemplateEntry('strokeWidth=2;html=1;shape=mxgraph.flowchart.start_1;whiteSpace=wrap;', 120, 60, 'Start', 'Start', null, null, 'start oval begin'),
	 	this.createVertexTemplateEntry('strokeWidth=2;html=1;shape=mxgraph.flowchart.terminator;whiteSpace=wrap;', 120, 60, 'End', 'End', null, null, 'end circle terminate'),
	 	this.createVertexTemplateEntry('strokeWidth=2;html=1;shape=mxgraph.flowchart.process;whiteSpace=wrap;', 120, 60, 'Buy', 'Buy', null, null, 'long buy box'),
	 	this.createVertexTemplateEntry('strokeWidth=2;html=1;shape=mxgraph.flowchart.process;whiteSpace=wrap;', 120, 60, 'Sell', 'Sell', null, null, 'short sell box'),
	];
	
	this.addPaletteFunctions('algo', mxResources.get('algo'), (expand != null) ? expand : true, fns);
};
